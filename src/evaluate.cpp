...
#define S(mg, eg) make_score(mg, eg)
  ...
  constexpr Score const *mobf(PieceType pt)
  {
      return pt == KNIGHT ? MobilityBonus      :
             pt == BISHOP ? MobilityBonus + 9  :
             pt == ROOK   ? MobilityBonus + 23 :
                            MobilityBonus + 38;
  }
