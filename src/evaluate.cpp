...
namespace {
  ...
  constexpr QScore MobilityBonus[][32] = {
    { Q(-60,-75,0,-3),Q(-52,-52,0,0),Q(-10,-34,-2,1),Q(-1,-15,-4,-2),Q(3,9,0,4),Q(13,17,-2,2),Q(21,17,2,2),Q(26,23,0,1),Q(37,26,4,0) },
    { Q(-48,-60,-3,-7),Q(-19,-25,-2,-2),Q(18,-9,-4,0),Q(31,8,2,-4),Q(42,21,1,-4),Q(51,39,-5,1),Q(53,57,2,-1),Q(54,60,0,0),Q(63,65,-2,2),Q(64,72,4,-1),Q(75,79,1,6),Q(87,87,-3,-4),Q(87,87,1,-3),Q(95,100,-4,2) },
    { Q(-61,-83,-1,-1),Q(-23,-15,-2,7),Q(2,17,6,-4),Q(3,45,-2,6),Q(6,71,3,-2),Q(14,101,1,-6),Q(23,107,-1,0),Q(30,124,-3,4),Q(41,135,1,-2),Q(41,141,5,-3),Q(42,156,-3,3),Q(45,160,-2,5),Q(56,167,1,-1),Q(56,169,-2,7),Q(67,177,-3,0) },
    { Q(-31,-46,4,2),Q(-14,-29,2,8),Q(-13,-10,-2,-1),Q(-7,15,-3,3),Q(15,45,-1,-1),Q(24,53,1,2),Q(24,54,-7,-3),Q(34,73,-4,1),Q(45,75,-1,-6),Q(54,95,3,1),Q(64,99,-5,0),Q(66,100,-3,-4),Q(70,125,-4,1),Q(70,126,-1,-5),Q(71,133,4,2),Q(73,137,0,3),Q(74,141,0,3),Q(75,142,2,2),Q(75,148,-1,-2),Q(75,148,-1,2),Q(91,152,-6,5),Q(104,169,-4,-1),Q(108,171,-5,-7),Q(109,176,-2,-6),Q(110,177,1,3),Q(116,185,0,-2),Q(116,186,3,-4),Q(120,219,-3,1) }
  };
...
#undef S
  ...
  QAcc Evaluation<T>::king() const {
    ...
    if (kingDanger > 100)
        // TODO Parametrize 3rd and 4th value
        score -= make_qscore(kingDanger * kingDanger / 4096, kingDanger / 16, 0, 0);
  ...
  QAcc Evaluation<T>::passed() const {
    ...
    while (b)
    {
        ...
        if (r > RANK_3)
        {
            ...
            // TODO Parametrize 3rd and 4th value
            bonus += make_qscore(0, (  king_proximity(Them, blockSq) * 19 / 4
            ...
            if (r != RANK_7)
                // TODO Parametrize 3rd and 4th value
                bonus -= make_qscore(0, king_proximity(Us, blockSq + Up) * w, 0, 0);
