    ...
    while (b1) {
        ...
        if (Pt == BISHOP || Pt == KNIGHT)
        {
            ...
            if (Pt == BISHOP)
            {
                ...
                if (auto midatk = attacks_bb<BISHOP>(s, pos.pieces(PAWN)) & ((Rank4BB | Rank5BB) & (FileCBB | FileDBB | FileEBB | FileFBB)); more_than_one(midatk))
                    score += (more_than_one(midatk & Center) ? LongDiagonalBishop : LongDiagonalBishop/2);
