...
Score Bonus[][RANK_NB][FILE_NB] = {
  ...
  { // Knight
   ...
   { S( -61, -40), S(-17,-27), S(  6, -8), S( 12, 29), S( 12, 29), S(  6, -8), S(-17,-27), S( -61, -40)},
  ...
  { // Queen
   { S( 3,-69), S(-5,-57), S(-5,-47), S( 4,-26), S( 4,-26), S(-5,-47), S(-5,-57), S( 3,-69)},
   { S(-3,-55), S( 5,-31), S( 8,-22), S(12, -4), S(12, -4), S( 8,-22), S( 5,-31), S(-3,-55)},
   { S(-3,-39), S( 6,-18), S(13, -9), S( 7,  3), S( 7,  3), S(13, -9), S( 6,-18), S(-3,-39)},
   { S( 4,-23), S( 5, -3), S( 9, 13), S( 8, 24), S( 8, 24), S( 9, 13), S( 5, -3), S( 4,-23)},
   { S( 0,-29), S(14, -6), S(12,  9), S( 5, 21), S( 5, 21), S(12,  9), S(14, -6), S( 0,-29)},
   { S(-4,-38), S(10,-18), S( 6,-12), S( 8,  1), S( 8,  1), S( 6,-12), S(10,-18), S(-4,-38)},
   { S(-5,-50), S( 6,-27), S(10,-24), S( 8, -8), S( 8, -8), S(10,-24), S( 6,-27), S(-5,-50)},
   { S(-2,-75), S(-2,-52), S( 1,-43), S(-2,-36), S(-2,-36), S( 1,-43), S(-2,-52), S(-2,-75)}
  },
  { // King
